...
默认使用 `http://127.0.0.1:7860`，端口被占用时会自动选择其他本地端口。支持 Windows 10/11 x64，以及 JPG、JPEG、PNG、WEBP 输入；输出格式可选 PNG 或 JPG，PNG 保留 Alpha，JPG 输出不透明 RGB 图片。图片只在本机处理，不会上传互联网。
